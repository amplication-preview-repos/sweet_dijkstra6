...
@InputType()
class BranchCreateNestedManyWithoutRepositoriesInput {
...
export { BranchCreateNestedManyWithoutRepositoriesInput as BranchCreateNestedManyWithoutRepositoriesInput };
